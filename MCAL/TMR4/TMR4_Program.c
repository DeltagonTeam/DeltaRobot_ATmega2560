 ...
 * Return 	: ErrorStatus			: Error Status of function
 */
ErrorStatus TMR4_CTC_MS(u16 incpy_u16TimeMilliSec, void (*inptr_vdCallback) (void))
{
	...
	Globptr_vdTMR4Callback = inptr_vdCallback;	/*Setting the pointer to function for use in the ISR*/
 ...
 * Return 	: ErrorStatus			: Error Status of function
 */
ErrorStatus TMR4_CTC_S(u16 incpy_u16TimeSec, void (*inptr_vdCallback) (void))
{
	if (TMR4_CTC_ONCE != Glob_u8TMR4_MODE && TMR4_CTC_REPEAT != Glob_u8TMR4_MODE)
	{
		return INVALID_FUNCTION;
 ...
 * Return 	: ErrorStatus			: Error Status of function
 */
ErrorStatus TMR4_Counter(u16 incpy_u16Count, void (*inptr_vdCallback) (void))
{
 ...
 * Return 	: ErrorStatus				: Error Status of function
 */
ErrorStatus TMR4_PWMStart(u16 incpy_u8Frequency, u8 incpy_u8DutyCycle, u8 incpy_u8RunCallBackFunc, void (*inptr_vdCallback) (void))
{
	...
	Globptr_vdTMR4Callback = inptr_vdCallback;
...
void __vector_42(void)
{
	...
	if (NULL != Globptr_vdTMR4Callback)
	{
		Globptr_vdTMR4Callback();
	}
}
